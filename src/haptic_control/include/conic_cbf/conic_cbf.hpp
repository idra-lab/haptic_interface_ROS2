...
Eigen::Quaterniond cbfOrientFilter(const Eigen::Quaterniond &q_ref,
    ...
    //     exit(1);
    // }
    // std::cout << "Barrier value 1: "<< h(R, Eigen::Vector3d::Unit(0), R_ref.col(0), thetas(0)) << std::endl;
    // std::cout << "Barrier value 2: "<< h(R, Eigen::Vector3d::Unit(1), R_ref.col(1), thetas(1)) << std::endl;
    // std::cout << "Barrier value 3: "<< h(R, Eigen::Vector3d::Unit(2), R_ref.col(2), thetas(2)) << std::endl;
    ...
    Eigen::Vector3d angle = u_nominal * dt;
