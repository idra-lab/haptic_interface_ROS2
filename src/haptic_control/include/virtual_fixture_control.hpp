...
public:
    ...
    void set_next_area_cb(const rclcpp::Parameter &p);
    ...
    void addVirtualFixtureForceOverlay(raptor_api_interfaces::msg::InVirtuoseForce &wrench);
    void computeVirtualFixtureError(raptor_api_interfaces::msg::InVirtuoseForce &vf_wrench);
...
protected:
    ...
    bool received_areas_ = false;
    int next_area_ = 11; // 1-14, 0 means first free motion transition
    bool is_in_transition_ = true; // true if in transition between areas
    ...
    raptor_api_interfaces::msg::InVirtuoseForce old_wrench_;
